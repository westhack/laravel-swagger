...
<script type="text/javascript" src="{{ asset('swagger/swagger-ui-bundle.js') }}"></script>
<script type="text/javascript" src="{{ asset('swagger/swagger-ui-standalone-preset.js') }}"></script>
